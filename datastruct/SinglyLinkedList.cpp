...
SinglyLinkedList::SinglyLinkedList(sf::RenderWindow &window, sf::Font &font) : mWindow(window), mFont(font), mType(0), mSmallType(0)
{
    mButton.resize(12);
    mBCreate.resize(2);
    mBInsert.resize(3);
...
SinglyLinkedList::Node::Node(std::string data)
{
    this->data = data;
    this->next = nullptr;
}

void SinglyLinkedList::update(bool mousePress, sf::Vector2i mousePosition, char &keyPress, int &mData, float dt)
{
    for (int i = 0; i < 8; i++)
...
void SinglyLinkedList::updateCreate(bool mousePress, sf::Vector2i mousePosition, char &keyPress)
{
...
void SinglyLinkedList::updateInsert(bool mousePress, sf::Vector2i mousePosition, char &keyPress)
{
    char tempkeyPress;
...
void SinglyLinkedList::updateRemove(bool mousePress, sf::Vector2i mousePosition, char &keyPress)
{
...
int SinglyLinkedList::Rand(int MAX)
{
    srand(time(NULL));
    return rand() % MAX;
}

void SinglyLinkedList::randomize()
{
    std::ofstream outFile("data/randomize.data");
